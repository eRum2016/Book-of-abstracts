...
\begin{center}
  {\bf \index[a]{Biecek Przemyslaw} Przemyslaw Biecek$^{1^\star}$}
\end{center}
...
\packages \index[p]{ggplot2} ggplot2; \index[p]{shiny} shiny; \index[p]{intsvy} intsvy; \index[p]{archivist} archivist; \index[p]{knitr} knitr; \index[p]{BetaBit} BetaBit; \index[p]{PISA2012lite} PISA2012lite
\end{minipage}
