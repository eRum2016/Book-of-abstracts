...
\begin{center}
  {\bf \index[a]{Mark Gergely} Gergely Mark$^{1}$, \index[a]{Somogyi Csongor} Csongor Somogyi$^{1}$, \index[a]{Kun David} David Kun$^{1^\star}$}
\end{center}
...
\packages \index[p]{base} base; \index[p]{roveR} roveR; \index[p]{shiny} shiny
\end{minipage}
