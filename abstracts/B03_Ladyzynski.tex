...
\begin{center}
  {\bf \index[a]{Ładyżyński Paweł} Paweł Ładyżyński$^{1^\star}$}
\end{center}
...
\packages \index[p]{data.table} data.table; \index[p]{dplyr} dplyr; \index[p]{ggplot2} ggplot2; \index[p]{h2o} h2o; \index[p]{rmarkdown} rmarkdown; \index[p]{shiny} shiny
\end{minipage}
