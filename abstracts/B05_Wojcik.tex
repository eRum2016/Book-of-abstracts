...
\begin{center}
  {\bf \index[a]{Wójcik Piotr} Piotr Wójcik$^{1^\star}$}
\end{center}
...
calculations
\packages \index[p]{xts} xts; \index[p]{chron} chron; \index[p]{quantmod} quantmod; \index[p]{Rbbg} Rbbg; \index[p]{IBrokers} IBrokers; \index[p]{TFX} TFX; \index[p]{tseries} tseries; \index[p]{PerformanceAnalytics} PerformanceAnalytics; \index[p]{caTools} caTools; \index[p]{TTR} TTR; \index[p]{inline} inline; \index[p]{Rcpp} Rccp; \index[p]{RcppArmadillo} RcppArmadillo
\end{minipage}
