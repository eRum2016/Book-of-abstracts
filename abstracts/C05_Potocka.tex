...
\begin{center}
  {\bf \index[a]{Potocka Natalia} Natalia Potocka$^{1^\star}$}
\end{center}
...
\packages \index[p]{rkafka} rkafka; \index[p]{elastic} elastic; \index[p]{httr} httr; \index[p]{RJBDC} RJDBC; \index[p]{RZabbix} RZabbix
\end{minipage}
