...
\begin{center}
  {\bf \index[a]{Shan Ming} Ming Shan$^{1^\star}$}
\end{center}
...
\packages \index[p]{bayesm} bayesm; \index[p]{cluster} cluster; \index[p]{dplyr} dplyr; \index[p]{fields} fields; \index[p]{ggplot2} ggplot2; \index[p]{kohonen} kohonen; \index[p]{lme4} lme4; \index[p]{leaflet} leaflet; \index[p]{magrittr} magrittr; \index[p]{maps} maps; \index[p]{maptools} maptools; \index[p]{party} party; \index[p]{rgdal} rgdal; \index[p]{rgeos} rgeos; \index[p]{sp} sp; \index[p]{spatstat} spatstat; \index[p]{shiny} shiny
\end{minipage}
