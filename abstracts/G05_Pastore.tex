...
\begin{center}
  {\bf \index[a]{Altoè Gianmarco} Gianmarco Altoè$^{1}$, \index[a]{Nucci Massimo} Massimo Nucci$^{1}$, \index[a]{Pastore Massimiliano} Massimiliano Pastore$^{1^\star}$}
\end{center}
...
\packages \index[p]{lavaan} lavaan; \index[p]{influence.SEM} influence.SEM
\end{minipage}
