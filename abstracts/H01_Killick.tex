...
\begin{center}
  {\bf \index[a]{Killick Rebecca} Rebecca Killick$^{1^\star}$, \index[a]{Beaulieu Claudie} Claudie Beaulieu$^{2}$, \index[a]{Taylor Simon} Simon Taylor$^{1}$}
\end{center}
...
\packages \index[p]{EnvCpt} EnvCpt; \index[p]{changepoint} changepoint
\end{minipage}
