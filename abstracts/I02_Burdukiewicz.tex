...
\begin{center}
  {\bf \index[a]{Burdukiewicz Michał} Michał Burdukiewicz$^{1^\star}$, \index[a]{Sobczyk Piotr} Piotr Sobczyk$^{2}$, \index[a]{Kotulska Małgorzata} Małgorzata Kotulska$^{3}$, \index[a]{Mackiewicz Paweł} Paweł Mackiewicz$^{1}$}
\end{center}
...
\packages \index[p]{biogram} biogram; \index[p]{ranger} ranger; \index[p]{slam} slam
\end{minipage}
