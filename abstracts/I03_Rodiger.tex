...
\begin{center}
  {\bf \index[a]{Rödiger Stefan} Stefan Rödiger$^{1^\star}$, \index[a]{Burdukiewicz Michał} Michał Burdukiewicz$^{2}$, \index[a]{Schierac Peter} Peter Schierac$^{1}$}
\end{center}
...
\packages \index[p]{chipPCR} chipPCR; \index[p]{dpcR} dpcR; \index[p]{MBmca} MBmca; \index[p]{RDML} RDML; \index[p]{rkwarddev} rkwarddev; \index[p]{qpcR} qpcR
\end{minipage}
