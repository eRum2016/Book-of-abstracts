...
\begin{center}
  {\bf \index[a]{Dyderski Marcin K.} Marcin K. Dyderski$^{1, 2^\star}$}
\end{center}
...
\packages \index[p]{caret} caret; \index[p]{randomForest} randomForest; \index[p]{ggplot2} ggplot2; \index[p]{hglm} hglm; \index[p]{sp} sp; \index[p]{rgeos} rgeos
\end{minipage}
