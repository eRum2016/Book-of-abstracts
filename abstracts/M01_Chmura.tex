...
\begin{center}
  {\bf \index[a]{Chmura Damian} Damian Chmura$^{1^\star}$, \index[a]{Salachna Anna} Anna Salachna$^{1}$, \index[a]{Sierka Edyta} Edyta Sierka$^{2}$}
\end{center}
...
coefficient
\packages \index[p]{nlme} nlme; \index[p]{multilevel} multilevel; \index[p]{irr} irr; \index[p]{betapart} betapart; \index[p]{vegan} vegan
\end{minipage}
