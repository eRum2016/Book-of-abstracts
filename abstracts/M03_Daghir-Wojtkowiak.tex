...
\begin{center}
  {\bf \index[a]{Daghir-Wojtkowiak Emilia} Emilia Daghir-Wojtkowiak$^{1^\star}$, \index[a]{Wiczling Paweł} Paweł Wiczling$^{1}$, \index[a]{Waszczuk-Jankowska Małgorzata} Małgorzata Waszczuk-Jankowska$^{1}$, \index[a]{Kaliszan Roman} Roman Kaliszan$^{1}$, \index[a]{Markuszewski Michał J.} Michał J. Markuszewski$^{1}$}
\end{center}
...
\packages \index[p]{runjags} runjags; \index[p]{coda} coda; \index[p]{caTools} caTools; \index[p]{MCMCglmm} MCMCglmm; \index[p]{caret} caret; \index[p]{Hmisc} Hmisc; \index[p]{lattice} lattice
\end{minipage}
