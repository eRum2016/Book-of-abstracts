...
\begin{center}
  {\bf \index[a]{Santos Fabián} Fabián Santos$^{1^\star}$, \index[a]{Menz Gunther} Gunther Menz$^{1}$, \index[a]{Dubvyky Olena} Olena Dubvyky$^{1}$}
\end{center}
...
monitoring
\packages \index[p]{GA} GA; \index[p]{changepoint} changepoint; \index[p]{BreakoutDetection} BreakoutDetection; \index[p]{ecp} ecp
\end{minipage}
