...
\begin{center}
  {\bf \index[a]{Wierzcholska Sylwia} Sylwia Wierzcholska$^{1^\star}$, \index[a]{Dyderski Marcin K.} Marcin K. Dyderski$^{2, 3}$, \index[a]{Jagodziński Andrzej M.} Andrzej M. Jagodziński$^{2, 3}$}
\end{center}
...
\packages \index[p]{dismo} dismo; \index[p]{rasterVis} rasterVis
\end{minipage}
