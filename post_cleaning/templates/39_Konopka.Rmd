...
author:
 - name: "Bogumil M. Konopka"
   affiliation: [1]
   email: "bogumil.konopka@pwr.edu.pl"
   contact: yes
 - name: "Felicja Lwow"
   affiliation: [2]
 - name: "Łukasz Łaczmański"
   affiliation: [3]   
affiliation:
...
were related to diseased patients: diabetes and gonadotroph adenoma
...
<!--  -->
<!-- **References** -->
<!-- [1] Mahalanobis PC, On the generalised distance in statistics, Proceedings of the National Institute of Science of India 12 1936. 49–55.
 [2] Murtagh F, Legendre P. Ward's hierarchical agglomerative clustering method: which algorithms implement Ward's criterion? Journal of Classification, 2014, 31 (3), 274-295
 [3] Gabriel KR, The biplot graphic display of matrices with application to principal component analysis., Biometrika (1971) 58 (3): 453-467 doi:10.1093/biomet/58.3.453 -->
