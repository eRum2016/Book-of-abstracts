...
long-term programing experiences. Here we present an automatic procedure
...
dividing it into few steps: (1) import and store Census data in SQLite
database, (2) preprocessing of geospatial data performed in GRASS GIS
software, (3) performing dasymetric modeling in R, (4) propagation model
for geospatial data and export geospatial data from R to GIS format to
map population distribution. Our results show that (1) R can perform
such a calculation in a reasonable time (60 hours for the entire U.S),
(2) no additional intermediate layers or steps are required (3)
